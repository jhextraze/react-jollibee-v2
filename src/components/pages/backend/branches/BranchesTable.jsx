...
const BranchesTable = ({ setIsBranchesEdit }) => {
  ...
  const handleEdit = (item) => {
    ...
    setIsBranchesEdit(item)
  };

  const handleArchive = (item) => {
    dispatch(setIsArchive(true));
    setIsId(item.branch_aid);
  };
    ...
    <>
          ...
          <table>
            <thead>
              <tr>
                <th>#</th>
                <th>Status</th>
                <th className="w-[50%]">Location Name</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
      ...
      {store.isArchive && (
        <ModalArchive
          ...
          mysqlEndpoint={`/v2/branches/active/${id}`}
          queryKey={"branches"}
        />
      )}
      {store.isRestore && (
